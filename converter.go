...
func NewConverter(fromEncoding, toEncoding string) (converter *Converter, err error) {
	...
	// free the C Strings
	defer C.free(unsafe.Pointer(toEncodingC))
	defer C.free(unsafe.Pointer(fromEncodingC))
...
func (this *Converter) Convert(input, output []byte) (bytesRead int, bytesWritten int, err error) {
